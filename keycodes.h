...
{
	enum class SCRIPTURES_API KeyCode
	{
		/// <summary>
		/// Left mouse button.
		/// </summary>
		...
		/// </summary>
		XP_BROWSER_BACK = 0xA6,
		/// <summary>
		/// Windows 2000/XP: Browser Forward key.
		/// </summary>
		XP_BROWSER_FORWARD = 0xA7,
		/// <summary>
		/// Windows 2000/XP: Browser Refresh key.
		/// </summary>
		XP_BROWSER_REFRESH = 0xA8,
		/// <summary>
		/// Windows 2000/XP: Browser Stop key.
		/// </summary>
		XP_BROWSER_STOP = 0xA9,
		/// <summary>
		/// Windows 2000/XP: Browser Search key.
		/// </summary>
		XP_BROWSER_SEARCH = 0xAA,
		/// <summary>
		/// Windows 2000/XP: Browser Favorites key.
		/// </summary>
		XP_BROWSER_FAVORITES = 0xAB,
		/// <summary>
		/// Windows 2000/XP: Browser Start and Home key.
		/// </summary>
			XP_BROWSER_HOME = 0xAC,
		/// <summary>
		...
		/// </summary>
			XP_MEDIA_NEXT_TRACK = 0xB0,
		/// <summary>
		/// Windows 2000/XP: Previous Track key.
		/// </summary>
			XP_MEDIA_PREV_TRACK = 0xB1,
		/// <summary>
